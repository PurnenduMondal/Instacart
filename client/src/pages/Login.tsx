                    ...
                    {isLoginState && (
                        <label className="text-sm flex flex-col gap-1">
                            ...
                            <div className='relative'>
                                ...
                                <input type="text" value={name} onChange={(e) => setName(e.target.value)} required className='w-full pl-11 pr-4 py-3 text-sm bg-white rounded-xl border not-focus:border-app-border transition-all' placeholder="Your name"/>
                            </div>
                        </label>
                    ) }
                    <label className="text-sm flex flex-col gap-1">
                        ...
                        <div className='relative'>
                            ...
                            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required className='w-full pl-11 pr-4 py-3 text-sm bg-white rounded-xl border not-focus:border-app-border transition-all' placeholder="you@example.com"/>
                        </div>
                    </label>
                    <label className="text-sm flex flex-col gap-1">
                            Password
                        <div className='relative'>
                            ...
                            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className='w-full pl-11 pr-4 py-3 text-sm bg-white rounded-xl border not-focus:border-app-border transition-all' placeholder="••••••••"/>
                        </div>
                    </label>
